...
type SiteSiteMetadata = {
  ...
  readonly facebookAppId: Maybe<Scalars['String']>;
};
...
type SiteSiteMetadataFilterInput = {
  ...
  readonly facebookAppId: Maybe<StringQueryOperatorInput>;
};
...
type PostPageQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'author'>> }>, readonly mdx: Maybe<(
...
type BioQuery = { readonly avatar: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }>, readonly site: Maybe<{ readonly siteMetadata: Maybe<(
...
type DefaultSEOQueryQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'description' | 'author' | 'lang' | 'siteUrl' | 'facebookAppId'>
      & { readonly social: Maybe<Pick<SiteSiteMetadataSocial, 'twitter'>> }
    )> }> };
